...
namespace FindActress.Behaviors
{
    /// <summary>
    ///     Copy from sample: https://github.com/xamarin/xamarin-forms-samples/tree/master/Behaviors/EventToCommandBehavior
    /// </summary>
    public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        private void DeregisterEvent(string name)
        {
            ...
            var eventInfo = AssociatedObject.GetType().GetRuntimeEvent(name);
            if (eventInfo == null) throw new ArgumentException(string.Format("EventToCommandBehavior: Can't de-register the '{0}' event.", EventName));
